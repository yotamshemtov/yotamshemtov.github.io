...
This paper studies the causal effect of incarceration on reoffending using discontinuities in state sentencing guidelines and two decades of administrative records from North Carolina. A regression discontinuity analysis shows that one year of incarceration reduces the likelihood of committing a new violent crime within three years of sentencing by over 30%. A key objective is to disentangle the incapacitation effects associated with an initial incarceration sentence from any behavioral effects of serving time on subsequent criminality. To parse these two effects, we develop an econometric model of sentencing length and recidivism. Our model allows for Roy-style selection into sentencing on the basis of latent criminality. We propose a two-step control function estimator of the model parameters, and show that our estimates accurately reproduce the reduced form effects of the sentencing discontinuities we study. Our parameter estimates indicate that incarceration has modest crime-reducing behavioral effects, with marginal effects that are diminishing in incarceration length. We then conduct a simple cost-benefit analysis which suggests that, despite the reductions in crime from more aggressive sentencing (through both incapacitation and behavioral channels), the high costs of incarceration may outweigh the social benefits of lower crime.
